...
fin_getService(methodName: string, params: any = null) {
  if (params) {
    ...
    return this.http.get(`http://103.177.225.135:9093/` + this.apihost + methodName + parmsdet);
  }else{
    return this.http.get(`http://103.177.225.135:9093/` + this.apihost + methodName);
  }
}
...
fin_postservice(methodName: string, params: any = null) {
  ...
  // JSON.stringify(data)
  return this.http
    .post<any>(`http://103.177.225.135:9093/` + this.apihost + methodName, params, { headers: reqHeader })
